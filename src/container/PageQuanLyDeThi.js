...
import TieuDeDeThi from '../Components/DeThi/TieuDeDeThi';
class PageQuanLyDeThi extends Component {
    constructor(props) {
        super(props);
        this.state = {
          statusTopNav: false,
...
const mapStateToProps = (state, ownProps) => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(PageQuanLyDeThi);
