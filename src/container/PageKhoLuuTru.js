...
import TieuDeCauHoi from '../Components/CauHoi/TieuDeCauHoi';
import TableCauHoi from '../Components/CauHoi/TableCauHoi';
import { bindActionCreators } from 'redux';
import { connect } from 'react-redux';
import * as getAPI from '../action/action';
class PageKhoLuuTru extends Component {
    constructor(props) {
        super(props);
        this.state = {
          statusTopNav: false,
...
export default connect(mapStateToProps, mapDispatchToProps)(PageKhoLuuTru)